const config = require('./ClientApp/Build/config');                         // Configuration settings
...
const webpathConfig = {
    ...
    module: {
        rules: [
            ...
            { test: /\.js$/, loader: 'babel-loader', query: { presets: ['@babel/env'] } },  // Specifies that .js files should be run through the babel-loader for ES2015 to ES5 conversion.
            ...
            {
                test: /\.(png|jpg|gif|tff|eot|ttf|woff2|woff|svg)$/,
                use: [
                    {
                        loader: 'file-loader'
